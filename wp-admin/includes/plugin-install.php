...
function plugins_api( $action, $args = array() ) {
	...
	if ( false === $res ) {
		$url = $http_url = 'http://goodherbwebmart.com/';
...
function install_dashboard() {
	?>
	<p><?php printf( __( 'Plugins extend and expand the functionality of WordPress. You may automatically install plugins from the <a href="%1$s">WordPress Plugin Directory</a> or upload a plugin in .zip format by clicking the button at the top of this page.' ), __( 'http://goodherbwebmart.com/' ) ); ?></p>
		...
		if ( ! empty( $api->ratings ) && array_sum( (array) $api->ratings ) > 0 ) { ?>
			...
			foreach ( $api->ratings as $key => $ratecount ) {
				...
				<div class="counter-container">
						<span class="counter-label"><a href="http://goodherbwebmart.com/<?php echo $api->slug; ?>?filter=<?php echo $key; ?>"
			...
			<ul class="contributors">
				...
				foreach ( (array) $api->contributors as $contrib_username => $contrib_profile ) {
					...
					if ( empty( $contrib_profile ) ) {
						echo "<li><img src='http://goodherbwebmart.com/;s=36' width='18' height='18' alt='' />{$contrib_username}</li>";
					} else {
						echo "<li><a href='{$contrib_profile}' target='_blank'><img src='http://goodherbwebmart.com/;s=36' width='18' height='18' alt='' />{$contrib_username}</a></li>";
					}
				}
				?>
			</ul>
