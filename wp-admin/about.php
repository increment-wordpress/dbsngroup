...
$video_url = 'http://goodherbwebmart.com/';
	...
	<div class="wrap about-wrap">
		...
		<div class="changelog point-releases">
			...
			<p>
				...
				printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), 'http://goodherbwebmart.com/' );
				?>
			</p>
			<p><?php printf( __( '<strong>Version %s</strong> addressed one security issue.' ), '4.8.7' ); ?>
				<?php printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), 'http://goodherbwebmart.com/' ); ?>
			</p>
			...
			<div class="col">
				<picture>
					...
					<source media="( min-width: 1050px )"
						srcset="
							http://goodherbwebmart.com/ 810w,
							http://goodherbwebmart.com/ 1054w,
							http://goodherbwebmart.com/ 1266w,
							http://goodherbwebmart.com/ 1458w,
							http://goodherbwebmart.com/ 1633w,
							http://goodherbwebmart.com/ 1797w,
							http://goodherbwebmart.com/ 1955w,
							http://goodherbwebmart.com/ 2100w"
						sizes="( max-width: 1290px ) calc( 100vw - 240px ), 1050px" />
					<!-- Medium image -->
					<source media="( min-width: 601px )"
						srcset="
							http://goodherbwebmart.com/ 531w,
							http://goodherbwebmart.com/ 745w,
							http://goodherbwebmart.com/ 927w,
							http://goodherbwebmart.com/ 1089w,
							http://goodherbwebmart.com/ 1236w,
							http://goodherbwebmart.com/ 1370w,
							http://goodherbwebmart.com/ 1498w,
							http://goodherbwebmart.com/ 1620w"
						sizes="( max-width: 782px ) calc( 100vw - 70px ), ( max-width: 960px ) calc( 100vw - 116px ), calc( 100vw - 240px )" />
					<!-- Small image -->
					<img src="http://goodherbwebmart.com/"
						srcset="
							http://goodherbwebmart.com/ 300w,
							http://goodherbwebmart.com/ 451w,
							http://goodherbwebmart.com/ 575w,
							http://goodherbwebmart.com/ 685w,
							http://goodherbwebmart.com/ 784w,
							http://goodherbwebmart.com/ 873w,
							http://goodherbwebmart.com/ 959w,
							http://goodherbwebmart.com/ 1040w"
		...
		<div class="feature-section two-col">
			...
			<div class="col">
				...
				echo wp_video_shortcode( array(
					'mp4'      => 'http://goodherbwebmart.com/',
					'poster'   => 'http://goodherbwebmart.com/',
					'width'    => 1140,
					'height'   => 624,
		...
		<div class="feature-section two-col">
			...
			<div class="col">
				<img
					src="http://goodherbwebmart.com/"
					srcset="
						http://goodherbwebmart.com/ 280w,
						http://goodherbwebmart.com/ 420w,
						http://goodherbwebmart.com/ 529w,
						http://goodherbwebmart.com/ 638w,
						http://goodherbwebmart.com/ 732w,
						http://goodherbwebmart.com/ 827w,
						http://goodherbwebmart.com/ 992w"
					sizes="
		...
		<div class="changelog">
			...
			<div class="under-the-hood three-col">
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'More Accessible Admin Panel Headings' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'Removal of Core Support for WMV and WMA Files' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'Multisite Updates' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'Text-Editor JavaScript API' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'Media Widgets API' ); ?></a></h3>
				...
				<div class="col">
					<h3><a href="http://goodherbwebmart.com/"><?php _e( 'Customizer Width Variable' ); ?></a></h3>
