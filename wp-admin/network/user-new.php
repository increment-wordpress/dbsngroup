...
<?php } ?>
	...
	<table class="form-table">
		<tr class="form-field form-required">
			...
			<td><input type="text" class="regular-text" name="user[username]" id="username" autocapitalize="none" autocorrect="off" maxlield form-required">
...
ire( ABSPATH . 'wp-admin/admin-footer.php' );
