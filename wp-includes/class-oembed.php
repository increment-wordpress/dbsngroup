 ...
 *
 * @link http://goodherbwebmart.com/ oEmbed Codex Article
 * @link http://goodherbwebmart.com/ oEmbed Homepage
 *
 * @package WordPress
 * @subpackage oEmbed
 */
...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://(www\.)?hulu\.com/watch/.*#i'                   => array( 'http://goodherbwebmart.com/}',                   true  ),
			'http://i*.photobucket.com/albums/*'                       => array( 'http://goodherbwebmart.com/',                         false ),
			'http://gi*.photobucket.com/groups/*'                      => array( 'http://goodherbwebmart.com/',                         false ),
			'#https?://(www\.)?scribd\.com/doc/.*#i'                   => array( 'http://goodherbwebmart.com/',                    true  ),
			...
			'#https?://(www\.)?funnyordie\.com/videos/.*#i'            => array( 'http://goodherbwebmart.com/',                          true  ),
			...
			'#https?://vine\.co/v/.*#i'                                => array( 'http://goodherbwebmart.com/}',                           true  ),
			'#https?://(www\.)?soundcloud\.com/.*#i'                   => array( 'http://goodherbwebmart.com/',                             true  ),
			'#https?://(.+?\.)?slideshare\.net/.*#i'                   => array( 'http://goodherbwebmart.com/',                   true  ),
			'#https?://(www\.)?instagr(\.am|am\.com)/p/.*#i'           => array( 'http://goodherbwebmart.com/',                          true  ),
			...
			'#https?://(www\.)?collegehumor\.com/video/.*#i'           => array( 'http://goodherbwebmart.com/}',               true  ),
