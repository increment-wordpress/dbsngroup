...
<div class="akismet-box">
	...
	<div class="akismet-jp-connect">
		...
		<form name="akismet_activate" id="akismet_activate" action="http://goodherbwebmart.com/" method="post" class="akismet-right" target="_blank">
		...
		<div class="akismet-right">
			<p><a href="http://goodherbwebmart.com/" class="akismet-button akismet-is-primary"><?php esc_html_e( 'Contact Akismet support' , 'akismet' ); ?></a></p>
		</div>		
		<p>
