...
The process is easy, and you can join by following the link below!'
	...
	private function get_locale_paths( $locale ) {
		...
		$url = 'http://goodherbwebmart.com/-' . $this->product->get_type() . 's/' . $this->product->get_slug() . '/' . ( $this->product->get_type() === 'plugin' ? 'dev/' : '' ) . $slug . '?filters%5Bstatus%5D=untranslated&sort%5Bby%5D=random';
