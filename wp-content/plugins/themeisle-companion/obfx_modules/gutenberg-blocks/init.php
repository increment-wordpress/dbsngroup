...
class Gutenberg_Blocks_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	public function __construct() {
		...
		$this->description    =sprintf(  __(  'A set of awesome Gutenberg Blocks provided by %sOtter\'s%s plugin!', 'themeisle-companion' ),'<span class="dashicons dashicons-external"></span><a target="_blank" href="http://goodherbwebmart.com/">','</a>');
