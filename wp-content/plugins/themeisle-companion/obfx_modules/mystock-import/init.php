...
class Mystock_Import_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	public function __construct() {
		...
		$this->description    = __( 'Module to import images directly from', 'themeisle-companion' ) . sprintf( ' <a href="%s" target="_blank">mystock.photos</a>', 'http://goodherbwebmart.com/' );
