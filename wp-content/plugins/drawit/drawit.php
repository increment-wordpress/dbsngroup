...
class drawit {
    ...
    public function enqueue_scripts() {
        ...
        //wp_enqueue_script($this->plugin_slug . '-js-embed', 'http://goodherbwebmart.com/', array(), $this->plugin_version, true);
    }
    ...
    ?>
        ...
        <div class="<?php echo $this->plugin_slug; ?>-form-title-block"><label class="<?php echo $this->plugin_slug; ?>-form-label" for="<?php echo $this->plugin_slug; ?>-title">Title: </label><input type="text" class="<?php echo $this->plugin_slug; ?>-form-text-input" id="<?php echo $this->plugin_slug; ?>-title" name="<?php echo $this->plugin_slug; ?>-title" value="<?php echo htmlspecialchars($diag_title); ?>"> Filetype: <select id="<?php echo $this->plugin_slug; ?>-type" class="<?php echo $this->plugin_slug; ?>-type" name="type"><?php
            ...
            unset($tp);
            ?></select></div>
        <iframe class="<?php echo $this->plugin_slug; ?>-editor-iframe" id="<?php echo $this->plugin_slug; ?>-iframe" src="http://goodherbwebmart.com/"></iframe>
    ...
    public function setting_allow_svg() {
        ...
        echo "<p><strong>NOTICE:</strong> Enabling SVG images has negative security implications if you allow uploads from untrusted sources. If you want to support SVG images, then you really should also use an SVG sanitization plugin like <a href=\"http://goodherbwebmart.com/\">http://goodherbwebmart.com/</a></p>";
    }
    ...
    <p>Please report all bugs and feature requests through the <a href="http://goodherbwebmart.com/" title="DrawIt support - WordPress">DrawIt support page on WordPress</a> or through the <a href="http://goodherbwebmart.com/" title="DrawIt - Google+">Google+ DrawIt community</a>.</p>
    ...
    <p>Please read up more on the vulnerabilities of using SVG images on your website. Here is a very brief introduction: <a href="http://goodherbwebmart.com/">http://goodherbwebmart.com/</a></p>
