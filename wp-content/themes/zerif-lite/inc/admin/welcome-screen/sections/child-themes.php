			...
			<div class="zerif-lite-child-theme-details">
				<?php if ( 'ZBlackBeard' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="http://goodherbwebmart.com/" class="button button-primary install right"><?php esc_html_e( 'Get now', 'zerif-lite' ); ?></a>
						<a class="button button-secondary preview right" target="_blank" href="http://goodherbwebmart.com/"><?php esc_html_e( 'Live Preview','zerif-lite'); ?></a>
			...
			<div class="zerif-lite-child-theme-details">
				<?php if ( 'ResponsiveBoat' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="http://goodherbwebmart.com/" class="button button-primary install right"><?php printf( __( 'Get %s now', 'zerif-lite' ), '<span class="screen-reader-text">ResponsiveBoat</span>' ); ?></a>
						<a class="button button-secondary preview right" target="_blank" href="http://goodherbwebmart.com/"><?php esc_html_e( 'Live Preview','zerif-lite'); ?></a>
						<div class="zerif-lite-clear"></div>
					</div>
				<?php } else { ?>
