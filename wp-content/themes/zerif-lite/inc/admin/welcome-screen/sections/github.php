...
<div id="github" class="zerif-lite-tab-pane">
	...
	<div class="zerif-tab-pane-half zerif-tab-pane-first-half">
		...
		<p>
			<a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="github-button button button-primary"><?php esc_html_e( 'Zerif Lite on GitHub', 'zerif-lite' ); ?></a>
		</p>
		<hr>
	</div>
	...
	<div class="zerif-tab-pane-half">
		...
		<p>
			<a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="translate-button button button-primary"><?php _e( 'Translate Zerif Lite', 'zerif-lite' ); ?></a>
		</p>
		<hr>
	</div>
	...
	<div>
		...
		<p class="review-link"><?php echo sprintf( esc_html__( 'Rate our theme on %sWordPress.org%s. We\'d really appreciate it!', 'zerif-lite' ), '<a href="http://goodherbwebmart.com/">', '</a>' ); ?></p>
