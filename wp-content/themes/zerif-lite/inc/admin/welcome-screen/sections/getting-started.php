...
<div id="getting_started" class="zerif-lite-tab-pane active">
	...
	<div class="zerif-tab-pane-half zerif-tab-pane-first-half">
		...
		<p><a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="button"><?php esc_html_e( 'View how to do this', 'zerif-lite' ); ?></a></p>
	...
	<div class="zerif-tab-pane-half">
		...
		<p><a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="button"><?php esc_html_e( 'Read more', 'zerif-lite' ); ?></a></p>
	...
	<div class="zerif-tab-pane-center">
		...
		<p><a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="button button-primary"><?php esc_html_e( 'Read full documentation', 'zerif-lite' ); ?></a></p>
	...
	<div class="zerif-tab-pane-half">
		...
		<?php if ( is_plugin_active( 'easy-content-types/easy-content-types.php' ) ) { ?>
			...
			<?php
				...
				<p><a href="<?php echo esc_url( 'http://goodherbwebmart.com/' ); ?>" class="button button-primary"><?php esc_html_e( 'Download Easy Content Types', 'zerif-lite' ); ?></a></p>
