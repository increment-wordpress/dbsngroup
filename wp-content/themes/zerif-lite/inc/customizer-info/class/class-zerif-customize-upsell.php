	...
	public function sections( $manager ) {
		...
		$manager->add_section( new Zerif_Customizer_Upsell_Pro( $manager, 'zerif-upsell-pro',
				array(
					...
					'label_url' => 'http://goodherbwebmart.com/',
		...
		$manager->add_section( new Zerif_Customizer_Upsell_Features( $manager, 'zerif-upsell-features-1',
				array(
					'upsell_text'               => sprintf( '<a href="'.esc_url( 'http://goodherbwebmart.com/' ).'" target="_blank">%s</a>' , __( 'View PRO version','zerif-lite' ) ).'. '.__( 'It adds a background video and a background slider.', 'zerif-lite' ),
		...
		$manager->add_section( new Zerif_Customizer_Upsell_Features( $manager, 'zerif-upsell-features-2',
				array(
					'upsell_text'               => sprintf( '<a href="'.esc_url( 'http://goodherbwebmart.com/' ).'" target="_blank">%s</a>' , __( 'View PRO version','zerif-lite' ) ).'. '.__( 'It adds 5 new sections, the ability to re-order existing ones and easily add custom content to frontpage.', 'zerif-lite' ),
					'panel'                     => 'panel_general',
					'priority'                  => 500,
				)
			)
