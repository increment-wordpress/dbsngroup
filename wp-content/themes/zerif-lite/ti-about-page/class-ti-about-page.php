 ...
 *				        'button_link' => esc_url( 'http://goodherbwebmart.com/' ),
 *				        'is_button' => true,
 *                      'is_new_tab' => false
 *				    ),
 *            ),
 ...
 *                        'image'         => 'http://goodherbwebmart.com/',
 ...
 *                'pro_theme_link'      => 'http://goodherbwebmart.com/',
	...
	class TI_About_Page {
		...
		public function ti_about_page_render() {
			...
			if ( ! empty( $welcome_title ) || ! empty( $welcome_content ) || ! empty( $this->tabs ) ) {
				...
				echo '<a href="http://goodherbwebmart.com/" target="_blank" class="wp-badge epsilon-welcome-logo"></a>';
