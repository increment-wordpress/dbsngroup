...
<footer id="footer" itemscope="itemscope" itemtype="http://goodherbwebmart.com/">
	...
	<div class="container">
		...
		<?php
			...
			! empty( $zerif_copyright ) || ! empty( $zerif_powered_by ) || ! empty( $zerif_socials_instagram ) ) {
				...
				echo '<div class="zerif-copyright-box"><a class="zerif-copyright" rel="nofollow"><i class="fa fa-copyright"></i>DBSNGroup2017 - All Rights Reserved </a>' . __( '<br />Developed by', 'zerif-lite' ) . ' ' . '<a class="zerif-copyright" href="' . esc_url( 'http://goodherbwebmart.com/' ) . '" ' . $attribut_new_tab . ' rel="nofollow"> ' . __( 'GoCentral', 'zerif-lite' ) . '</a></div>';
